...
// Validate ../../src/app/api/photobook/upload/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/photobook/upload">> = Specific
  const handler = {} as typeof import("../../src/app/api/photobook/upload/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
